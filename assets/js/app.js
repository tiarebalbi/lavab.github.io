...
$(document).ready(function() {
  ...
  $('.desktop-menu').append('<a href="."><div class="logo-full"></div></a><div class="desktop-menu-buttons"><a href="https://mail.lavaboom.com"><button class="menu-login clear-blue-button button"></button></a><a href="signup"><button class="blue-button menu-signup button"></button></div></a><div class="desktop-menu-list-div"><ul class="desktop-menu-list"></ul></div>');
  $('.desktop-menu-list').append('<a href="features"><li class="desktop-menu-list-item features-menu-item">Features</li></a>');
  $('.desktop-menu-list').append('<a href="security"><li class="desktop-menu-list-item security-menu-item">Security</li></a>');
...
// CTA's are here
  ...
  var d = new Date();
  $('.getMonth').append(monthNames[d.getMonth()]);
...
var v3 = new attackVector("Server-side encryption","Andrei and Felix: here we need a paragraph on what protects our servers from attacks, where they are located, who has access, who has the SSL keys, what is the legal framework that protects these SSL keys. Then talk about what happens to user data coming onto our server, what is encrypted? Also talk about Lavaboom Sync and the key exchange");
